...
class PublicUserAPITest(TestCase):
    ...
    def test_password_too_short(self):
        ...
        payload = {
            'email': 'jana@craftec.solutions', 'password': 'pw', 'name': 'Jana'
        }
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='jana@craftec.solutions', password='testpass')
        payload = {
            'email': 'jana@craftec.solutions',
            'password': 'wrongpass'
        }
...
class PrivateUserApiTests(TestCase):
    ...
    def test_provide_user_profile(self):
